      ...
      <div className="about-container">
        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            <div className="feature-card">Real-time price updates</div>
            <div className="feature-card">Multi-platform comparison</div>
            <div className="feature-card">Wishlist & target prices</div>
            <div className="feature-card">Price drop notifications</div>
            <div className="feature-card"> Clean & easy-to-use interface</div>
          </div>
        </section>
